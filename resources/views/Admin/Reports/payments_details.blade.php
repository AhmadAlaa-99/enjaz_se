                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">تفاصيل سداد الدفعات</li>
                        </ul>
                    </div>
                    <div class="col-auto">
                                    ...
                                    <tbody>
                                        ...
                                        @forelse ($payments as $payment)
                                            ...
                                            <tr class="table-light">
                                                ...
                                                <td>
                                                    <a href="{{ route('payment.details', $payment->id) }}"class="btn btn-sm btn-white text-success me-2"><i
                                                            class="far fa-star me-1"></i> طباعة </a>
                                                </td>
                                                <td class="text-end">
                                                    <a href="#edit{{ $payment->id }}" data-bs-toggle="modal"
                                                        class="btn btn-sm btn-white text-success me-2"><i
                                                            class="far fa-star me-1"></i>اضافة مبلغ</a>
                                                </td>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="myModalLabel">اضافة مبلغ</h5>
