                            ...
                            <li class="breadcrumb-item invoices-breadcrumb-item">
                                <div class="col-auto">
                                    <div class="invoices-create-btn">
                                        ...
                                        <a href="{{ route('lease_edit', $lease->id) }}" class="btn save-invoice-btn">
                                            تعديل بيانات العقد
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="invoice-issues-box">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4">
                                            <div class="invoice-issues-date">
                                                <p> تاريخ نهاية العقد : {{ $lease->end_rental_date->format('Y-m-d') }}</p>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-4">
                                            <div class="invoice-issues-date">
                                                <p> صلاحية العقد : @if ($lease->status == 'expired')
                                                        منتهي
                                                ...
                                                <table class="table table-bordered table-striped m-0">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                @if ($lease->units->kitchen_Cabinets == 'No')
                                                                    لا
                                                                @else
                                                                    نعم
                                                                @endif
