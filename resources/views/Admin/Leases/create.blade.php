                ...
                <form action="{{ route('leases.store') }}" method="post" enctype="multipart/form-data"autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <div class="grid">
                            <div class="col-1-4">
                                <div class="controls">
                                    ...
                                    <input type="text" name="t_name"
                                        value="{{ old('t_name') }}"class="floatLabel"required>
                            ...
                            <div class="col-1-4">
                                <div class="controls">
                                    <input type="text" name="t_ID_num"
                                        value="{{ old('t_ID_num') }}"class="floatLabel"required>
                            ...
                            <div class="col-1-4">
                                <div class="controls">
                                    <input type="email" name="t_email"
                                        value="{{ old('t_email') }}"class="floatLabel"required>
                            ...
                            <div class="col-1-4">
                                <div class="controls">
                                    <input type="text" name="t_phone"
                                        value="{{ old('t_phone') }}"class="floatLabel"required>
                            ...
                            <div class="col-1-4">
                                <div class="controls">
                                    ...
                                    <input type="text" name="t_telephone"
                                        value="{{ old('t_telephone') }}"class="floatLabel">
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th> حالة الأثاث : </br></br>{{ $unit->furnished_mode }}</th>
                                                                                                                <th> خزائن مطبخ : </br></br>
 @if($unit->kitchen_Cabinets=="No")
 لا@else نعم @endif</th>
                                ...
                                <div class="col-1-3">
                                    <div class="controls">
                                        <input type="text" name="ejar_cost" id="Amount_Commission"
                                            class="floatLabel"value="{{ old('ejar_cost') }}" onchange="myFunction()"
                                            required>
                                        ...
                                        <div class="col-1-3">
                                            <div class="controls">
                                                <input type="text" id="Value_VAT" name="tax_ammount"
                                                    class="floatLabel"value="{{ old('tax_ammount') }}"readonly>
                                        ...
                                        <div class="col-1-3">
                                            <div class="controls">
                                                <input type="text" id="Total" name="rent_value"
                                                    class="floatLabel"value="{{ old('rent_value') }}"readonly>
                             ...
                             <h3> تنويه : القسط الأول والثاني يتضمن قسط المياه السنوي وقدره الف ريال سعودي </h3>
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-striped m-0" id="tableEstimate">
                                                    <thead>
                                                        <tr>
                                                            <th>تاريخ الاصدار</th>
                                                    ...
                                                    <tbody class="add">
                                                        <tr>
                                                            ...
                                                            <td><input class="form-control" type="date"
                                                                    id="release_date" name="release_date[]"required></td>
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        ...
                                        <div class="mb-3">
                                            <input class="form-control"
                                                name="docFile" value="exm.pdf"accept=".pdf,.jpg, .png, image/jpeg, image/png"type="file"
                                                id="formFileDisabled">
                                        </div>
