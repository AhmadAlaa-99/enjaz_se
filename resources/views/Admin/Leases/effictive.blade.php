                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-8 col-md-8">
                                    <div class="invoices-tabs">
                                        <ul>
                                            <li><a href="{{ url('/' . ($page = 'Admin/effictive')) }}"class="active">العقود
                                                    الجارية</a></li>
                                            ...
                                            @forelse ($leases as $lease)
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="badge badge-success">{{ $lease->units->number }}</td>
                                                                                                        <td><span class="badge badge-warning">@if($lease->type=="new")جديد @else مجدد @endif</td>
                                                   ...
                                                   <td><span
                                                            ...
                                                            @if($lease->financial->payment_cycle=="quarterly")ربع سنوي @elseif($lease->financial->payment_cycle=="monthly")شهري
                                                            @elseif($lease->financial->payment_cycle=="midterm") نصف سنوي@else سنوي@endif
                                                    </td>
                                                    <td><span
