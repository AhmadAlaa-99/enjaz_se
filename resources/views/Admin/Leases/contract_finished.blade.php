                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-8 col-md-8">
                                    <div class="invoices-tabs">
                                        <ul>
                                            <li><a href="{{ route('contract_effictive') }}">العقود الجارية</a></li>
                                            <li><a href="{{ route('contract_finished') }}" class="active">العقود
                                                    المنتهية</a></li>
                                        </ul>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            @forelse ($contracts as $contract)
                                                ...
                                                <tr>
                                                    <td>{{ $i }}</td>
                                                    <td><span
                                                            class="badge bg-success-light">{{ $contract->contactNo }}</span>
                                                    </td>
                                                    <td><span
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                ...
                                                                <a class="dropdown-item"
                                                                    href="{{ route('renew.contract', $contract->id) }}"><i
                                                                        class="far fa-check-circle me-2"></i>تجديد العقد</a>
