                                        ...
                                        <font face="Arial, Helvetica, sans-serif" size="4" color="#57697e"
                                            ...
                                            <table width="90%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td>
                                                        شركة روعة انجاز<br />
                                                        عزيزي المستأجر اليوم هذا اشعار بانتهاء عقد الايجار<br />
                                                ...
                                                <tr>
                                                    <td align="center">
                                                        <div style="line-height: 24px;">
                                                            <a href="{{ route('tn_lease.details', $lease->id) }}"
                                                                target="_blank" class="btn btn-danger block-center">
                                                                تفاصيل عقد الايجار
                                                            </a>
                                                        </div>
                                                        <!-- padding -->
                                            ...
                                            <tr>
                                                <td align="center"
                                                    ...
                                                    <font face="Arial, Helvetica, sans-serif" size="3"
                                                        color="#96a5b5" style="font-size: 13px;">
                                                        <span
